...
public class GetStartedSample {
    ...
    private static String accessKeyId = "LTAI4Fib13u2BHxVJDZWEa48";
    private static String accessKeySecret = "HKdpQvEXWyjIvCqXP7LCQ47Ifbg6x0";
    private static String bucketName = "tunte";
