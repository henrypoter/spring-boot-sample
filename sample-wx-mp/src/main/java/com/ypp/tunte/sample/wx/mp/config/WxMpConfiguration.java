package com.ypp.tunte.sample.wx.mp.config;

import com.google.common.collect.Maps;
import com.ypp.tunte.sample.wx.mp.entity.MpAccount;
import com.ypp.tunte.sample.wx.mp.handler.*;
import com.ypp.tunte.sample.wx.mp.repository.MpAccountRepository;
...
public class WxMpConfiguration {
    ...
    public WxMpService wxMpService() {
        ...
        if (list.isEmpty()){
            throw new RuntimeException("请至少配置一个您的公众号账户");
        }
        service.setMultiConfigStorages(list.stream().map(a -> {
